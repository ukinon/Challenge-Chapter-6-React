    ...
    >
      <div className="row justify-content-start justify-content-sm-center gap-2 w-100 footer">
        <div className="col-auto d-flex flex-column gap-1">
          ...
          <p className="footerText">binarcarrental@gmail.com</p>
          <p className="footerText">081-233-334-808</p>
        </div>
        <div className="col-auto d-flex flex-column gap-1">
          <a href="#service" className="footerAnchor">
            Our Services
          </a>
          <a href="#whyUs" className="footerAnchor">
            Why Us
          </a>
          <a href="#testi" className="footerAnchor">
            Testimonial
          </a>
          <a href="#faq" className="footerAnchor">
            FAQ
          </a>
        </div>
        <div className="col-auto d-flex flex-column gap-1">
        ...
        <div className="col-auto d-flex flex-column gap-1">
          <p className="footerText">Copyright Binar 2022</p>
